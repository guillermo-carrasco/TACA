...
@click.option('--operator', type=click.STRING, default=None, nargs=-1,
...
def project(ctx, projectid):
    ...
    print("Will deliver {}".format(projectid))
    d = _deliver.ProjectDeliverer(projectid,**ctx.parent.params)
    d.deliver_project()
