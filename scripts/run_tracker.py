...
def prepare_sample_sheet(run, config):
    ...
    FCID_samplesheet_dest_dict = sampleSheetMassage(FCID_samplesheet_origin_dict, FCID_samplesheet_origin) # massage the sample sheet
...
def sampleSheetMassage(samplesheet_dict, samplesheet_name=''):
